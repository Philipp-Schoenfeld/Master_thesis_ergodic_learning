...
# Ablation: sehr viel ergodischer Loss (w=50) — Erwartung: moeglicherweise
# instabiles/unglattes Flowfeld, weil der CFM-Term (der ueberhaupt ein
# gueltiges Vektorfeld sicherstellt) an Einfluss verliert. Interessanter
# Grenzfall, nicht unbedingt der beste Punkt der Reihe.
