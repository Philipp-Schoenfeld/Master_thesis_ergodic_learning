...
# Ablation: mittlerer ergodischer Loss (w=5) — bereits getestete Konfiguration
# (siehe checkpoints/..._C50_..._ERGLOSS-w5-K8-tp2_final.pt), hier mit C15 für
# direkte Vergleichbarkeit innerhalb dieser Ablationsreihe neu aufgesetzt.
